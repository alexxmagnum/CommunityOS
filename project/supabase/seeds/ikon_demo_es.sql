-- =============================================================================
-- IKON demo en español — ejecutar UNA vez en Supabase SQL Editor
-- Corrige seed legacy en inglés + datos de sistema (roles, deportes)
-- =============================================================================

-- Trigger updated_at seguro (tablas sin columna updated_at)
